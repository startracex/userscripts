// ==UserScript==
// @name         Shiro Wang's juejin extension
// @description  A user script to block ads/clickbait on Juejin.
// @version      0.1.0
// @author       startracex
// @license      MIT
// @updateURL    https://raw.githubusercontent.com/startracex/userscripts/release/juejin.dev.js
// @downloadURL  https://raw.githubusercontent.com/startracex/userscripts/release/juejin.dev.js
// @homepage     https://github.com/startracex/userscripts/blob/main/packages/juejin
// @homepageURL  https://github.com/startracex/userscripts/blob/main/packages/juejin/README.md
...
(function () {
  ...
  const waitForQuery = (query, callback, options) => {
  ...
  [{
  	...
  	handler: () => {
  		waitForQuery(() => document.querySelector(".entry-list"), (list) => {
  	...
  	matches: /^\/post\/.*$/,
  	handler: () => {
  		waitForQuery(() => document.querySelector(`.entry-list.recommended-entry-list`), (list) => {
  			[...list.children].forEach(executeHide);
  		}, 250);
  ...
  waitForQuery(() => document.querySelector(".global-banner-close"), (e) => {
  	e.click();
  }, 250);
  const styleElement = document.createElement("style");
